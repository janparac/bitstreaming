...
#set_property -dict { PACKAGE_PIN A8   IOSTANDARD LVCMOS33 } [get_ports {i_en}]   ; #IO_L12N_T1_MRCC_16 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN H5  IOSTANDARD LVCMOS33 } [get_ports { o_res[0]}]   ; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN J5  IOSTANDARD LVCMOS33 } [get_ports { o_res[1] }]   ; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN T9  IOSTANDARD LVCMOS33 } [get_ports { o_res[2] }]   ;
set_property -dict { PACKAGE_PIN T10 IOSTANDARD LVCMOS33 } [get_ports { o_res[3]}]   ; #IO_L24N_T3_A00_D16_14 Sch=led[7]
 #IO_L24P_T3_A01_D17_14 Sch=led[6]
##set_property CLOCK_DEDICATED_ROUTE FALSE [det_nets i_en_IBUF]

######################
##   push-buttons   ##
######################

set_property -dict { PACKAGE_PIN D9  IOSTANDARD LVCMOS33 } [get_ports { i_en }];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_en]   ; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
#set_property -dict { PACKAGE_PIN G13  IOSTANDARD LVCMOS33 } [get_ports { o_ }]   ; #IO_0_15 Sch=ja[1]
...
#set_property -dict { PACKAGE_PIN D10 IOSTANDARD LVCMOS33 } [get_ports { sign}]  ; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out
